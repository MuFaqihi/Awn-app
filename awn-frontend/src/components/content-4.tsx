...
export default function ContentSection({ locale = 'ar' }: { locale?: Locale }) {
  ...
  const t = isAr
    ? {
        ...
        subtitle:
          'عوْن تساعدك على إيجاد الأخصائي المرخّص، حجز موعد يناسبك، ومعرفة تفاصيل الجلسة بوضوح — في  المنزل، أو أونلاين.',
        ...
        cards: [
          ...
          },
          {
            ...
            body: '  منزلية، أو أونلاين مع تفاصيل المكان والمدة والسعر التقديري.',
          },
        ],
        badges: [
