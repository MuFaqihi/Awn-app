...
/* ──────────────────────────────────────────────────────────────
   Lightweight local useMeasure (no external deps)
────────────────────────────────────────────────────────────── */
...
/** React DOM props × Motion props compatibility layer */
type DOMEventsFix = Omit<
  ...
  | "onDragEnd"
>
type DivMotionProps = DOMEventsFix & MotionProps
...
/* ──────────────────────────────────────────────────────────────
   Expandable (root)
────────────────────────────────────────────────────────────── */
type ExpandablePropsBase = Omit<DivMotionProps, "children">
...
const Expandable = React.forwardRef<HTMLDivElement, ExpandableProps>(
  (
    ...
    const ctx: ExpandableContextType = {
      isExpanded,
      toggleExpand,
      expandDirection,
      expandBehavior,
...
>(
  (
    ...
    useEffect(() => {
      if (isExpanded) animatedHeight.set(measuredHeight)
      else animatedHeight.set(0)
...
/* ──────────────────────────────────────────────────────────────
   ExpandableCard
────────────────────────────────────────────────────────────── */
interface ExpandableCardProps extends DivMotionProps {
  children: ReactNode
  className?: string
  ...
  (
    ...
    return (
      <motion.div
        ...
        {...props}  /* accepts id, data-*, aria-*, Motion props */
      >
        <div
          className={cn(
