...
const toastTypeVariants = cva('rounded-lg shadow-lg border', {
  variants: {
    type: {
      loading: 'bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 border-gray-200 dark:border-gray-700',
